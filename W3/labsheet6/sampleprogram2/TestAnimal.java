...
import W3.labsheet6.sampleprogram2.Animal;

public class TestAnimal {
    public static void main( String args[]) {

        W3.labsheet6.sampleprogram2.Animal allAnimals[] = new W3.labsheet6.sampleprogram2.Animal[10];

        System.out.println("Calling the no-argument constructor to create the first animal....");
        W3.labsheet6.sampleprogram2.Animal animal1 = new W3.labsheet6.sampleprogram2.Animal(); //tests no-arg constructor
        ...
        W3.labsheet6.sampleprogram2.Animal animal2  = new W3.labsheet6.sampleprogram2.Animal("Lion",lionContinents,200,40);

        System.out.println("\nCalling the 4-argument constructor to create a rat object....");
        W3.labsheet6.sampleprogram2.Animal animal3  = new W3.labsheet6.sampleprogram2.Animal("Rat",new String[]{"Europe","America","Africa","Asia"},0.2,5);

        System.out.println("\nCalling the 4-argument constructor to create a polar bear object....");
        W3.labsheet6.sampleprogram2.Animal animal4  = new Animal("Polar Bear",new String[]{"Antarctica"},450,15);
